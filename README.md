- desktop client-server application that allows testers to report bugs, programmers to choose which bugs they want to fix and chat between them on a specific bug
